...
static volatile uint32_t systick_reload = 0;
static volatile uint32_t systick_tick_hz = 0;
static volatile uint32_t systick_ms_accum = 0;
...
static uint32_t systick_get_ms(void) { return systick_ms_accum; }
...
uint32_t ext_random_u32(void) { return xorshift32(); }
