...
Examples:
  ...
  %(prog)s -a out.wav
    ...
    parser.add_argument('-u', '--unit-addr',
                        type=int, default=75012,
                        help='Unit address (0-131071, default: 75012)')

    # Pressure
    parser.add_argument('-p', '--pressure',
                        type=int, default=70,
                        help='Pressure value (0-127, default: 70)')

    # Battery charge
    parser.add_argument('-c', '--battery-charge-used',
                        type=int, default=30,
                        help='Battery charge used (0-127, default: 30)')
    ...
    parser.add_argument('--confirmation-indicator', '--confirm',
                        ...
                        help='Confirmation indicator (default: False)')
    ...
    parser.add_argument('--turbine',
                        type=str2bool, nargs='?', const=True, default=False,
                        help='Turbine status (default: False)')
    ...
    parser.add_argument('-s', '--bit-sync-bits',
                        type=int, default=64,
                        help='Number of bit sync bits (default: 64)')
...
def main():
    ...
    if not (0 <= args.battery_charge_used <= 127):
    ...
    try:
        ...
        eot = EOTPacket(
            ...
            batt_charge=args.battery_charge_used,
